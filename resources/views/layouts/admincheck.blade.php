...
<div id="wrapper">
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-expand-sm navbar-light bg-light mb-3" role="navigation" >
        <div class="nav-item dropdown">
            <button type="button" class="dropdown-toggle" data-toggle="dropdown" data-target=".navbar-collapse">
        ...
        <div class="nav nav-pills flex-column" role="navigation">
